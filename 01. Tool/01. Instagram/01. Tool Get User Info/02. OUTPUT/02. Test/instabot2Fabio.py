...
updateUserdf.to_csv('{}_users_followed_list.csv'.format(strftime("%Y%m%d-%H%M%S"))


/html/body
//*[@id="react-root"]/section/main/div/div/article/div[1]
//*[@id="react-root"]/section/main/div/div/article/div[2]

//*[@id="react-root"]/section/main/div/div/article/div[2]/div[1]/ul/ul[1]/div/li/div/div[1]/div[1]

//*[@id="react-root"]/section/main/div/div/article/div[2]/div[1]/ul/ul[1]/div/li/div/div[1]/div[2]/h3

//*[@id="react-root"]/section/main/div/div/article/div[2]


//*[@id="react-root"]/section/main/div/div/article/div[1]/div/div/div[2]/button

//*[@id="react-root"]/section/main/div/div/article/div[1]/div/div
